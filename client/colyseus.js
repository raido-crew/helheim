var Colyseus = function (t) {
    ...
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0}), e.encode = r(13), e.decode = r(14)
}, function (t, e, r) {
    "use strict";
    ...
    var n = r(4), i = r(5), o = function () {
        ...
        return Object.defineProperty(t.prototype, "valueClasses", {
            get: function () {
                ...
                for (var e = this._valueClasses.length; e--;) if (!(this._valueClasses[e] instanceof Object)) throw new Error("Invalid valueClasses argument: item at index " + e + " should be a Class but was:<" + this._valueClasses[e] + ">." + this._valueClasses[e])
            ...
            for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
            var r = this._valueClasses.length, n = t.length;
            if (n < r) throw new Error("Incorrect number of arguments. Expected at least " + r + " but received " + n + ".");
            for (var i = 0; i < r; i++) if (!(null === t[i] || t[i] instanceof this._valueClasses[i] || t[i].constructor === this._valueClasses[i])) throw new Error("Value object <" + t[i] + "> is not an instance of <" + this._valueClasses[i] + ">.");
            var o = this.slots;
            if (o.nonEmpty) for (; o.nonEmpty;) o.head.execute(t), o = o.tail
    ...
    Object.defineProperty(e, "__esModule", {value: !0});
    var i = r(15), o = r(0), s = function (t) {
        function e(e, r) {
            void 0 === r && (r = !0);
            var n = t.call(this, e, void 0, {connect: r}) || this;
            return n._enqueuedCalls = [], n
        }

        return n(e, t), e.prototype.onOpenCallback = function (e) {
            if (t.prototype.onOpenCallback.call(this), this.binaryType = "arraybuffer", this._enqueuedCalls.length > 0) {
    ...
    (function (t) {
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var i = r(22), o = r(2), s = r(23), a = r(26), u = r(0), f = r(6), h = r(1), c = function (e) {
            function r(t, r) {
                var n = e.call(this, {}) || this;
                return n.clock = new i, n.remoteClock = new i, n.onJoin = new o.Signal, n.onStateChange = new o.Signal, n.onMessage = new o.Signal, n.onError = new o.Signal, n.onLeave = new o.Signal, n.id = null, n.name = t, n.options = r, n.connection = new f.Connection(void 0, !1), n.onLeave.add(function () {
                    return n.removeAllListeners()
                }), n
            }

            return n(r, e), r.prototype.connect = function (t) {
                var e = this;
                this.connection.url = t, this.connection.reconnectEnabled = !1, this.connection.onmessage = this.onMessageCallback.bind(this), this.connection.onclose = function (t) {
                ...
                this.connection ? this.connection.send([h.Protocol.LEAVE_ROOM]) : this.onLeave.dispatch()
            }, r.prototype.send = function (t) {
                this.connection.send([h.Protocol.ROOM_DATA, this.id, t])
            }, Object.defineProperty(r.prototype, "hasJoined", {
                get: function () {
                    return void 0 !== this.sessionId
                }, enumerable: !0, configurable: !0
            }), r.prototype.removeAllListeners = function () {
                e.prototype.removeAllListeners.call(this), this.onJoin.removeAll(), this.onStateChange.removeAll(), this.onMessage.removeAll(), this.onError.removeAll(), this.onLeave.removeAll()
            }, r.prototype.onMessageCallback = function (t) {
                var e = u.decode(new Uint8Array(t.data)), r = e[0];
                if (r === h.Protocol.JOIN_ROOM) this.sessionId = e[1], this.onJoin.dispatch(); else if (r === h.Protocol.JOIN_ERROR) console.error("Error: " + e[1]), this.onError.dispatch(e[1]); else if (r === h.Protocol.ROOM_STATE) {
                    var n = e[1], i = e[2], o = e[3];
                    this.setState(n, i, o)
                } else r === h.Protocol.ROOM_STATE_PATCH ? this.patch(e[1]) : r === h.Protocol.ROOM_DATA ? this.onMessage.dispatch(e[1]) : r === h.Protocol.LEAVE_ROOM && this.leave()
            }, r.prototype.setState = function (t, e, r) {
                var n = u.decode(t);
    ...
    function h(t, e, r, n) {
        return void 0 === e && (e = "var"), function (i, o) {
    ...
    function p(t, e, r, n, i) {
        if (t) {
            Object.defineProperty(r, "$room", {configurable: !0, enumerable: !1, value: e, writable: !0}), r.$room = e;
    ...
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0}), r(10);
    var n = r(11);
    e.Client = n.Client;
    var i = r(1);
    ...
    "use strict";
    Object.defineProperty(e, "__esModule", {value: !0});
    var n = r(2), i = r(0), o = r(6), s = r(1), a = r(7), u = r(27), f = function () {
        function t(t) {
            var e = this;
        ...
        return t.prototype.join = function (t, e) {
            return void 0 === e && (e = {}), this.createRoomRequest(t, e)
        }, t.prototype.rejoin = function (t, e) {
            return this.join(t, {sessionId: e})
        }, t.prototype.getAvailableRooms = function (t, e) {
            var r = this, n = ++this.requestId, i = function () {
            ...
            return void 0 === e && (e = {}), new a.Room(t, e)
        }, t.prototype.createRoomRequest = function (t, e, r, n) {
            var i = this;
            e.requestId = ++this.requestId;
            var o = r || this.createRoom(t, e);
            return o.onLeave.addOnce(function () {
                delete i.rooms[o.id], delete i.connectingRooms[e.requestId]
            }), e.retryTimes && o.onError.addOnce(function () {
                n = n || 0, !o.hasJoined && n <= e.retryTimes && (n++, i.createRoomRequest(t, e, o, n))
            }), this.connectingRooms[e.requestId] = o, this.connection.send([s.Protocol.JOIN_ROOM, t, e]), o
        }, t.prototype.connect = function (t) {
            var e = this;
            this.id = t || "", this.connection = new o.Connection(this.buildEndpoint()), this.connection.onmessage = this.onMessageCallback.bind(this), this.connection.onclose = function (t) {
            ...
            return this.hostname + "/" + t + "?" + r.join("&")
        }, t.prototype.onMessageCallback = function (t) {
            var e = i.decode(new Uint8Array(t.data)), r = e[0];
            if (r === s.Protocol.USER_ID) u.setItem("colyseusid", e[1]), this.id = e[1], this.onOpen.dispatch(); else if (r === s.Protocol.JOIN_ROOM) {
                var n = e[2], o = this.connectingRooms[n];
                if (!o) return void console.warn("colyseus.js: client left room before receiving session id.");
                o.id = e[1], this.rooms[o.id] = o, o.connect(this.buildEndpoint(o.id, o.options)), delete this.connectingRooms[n]
    ...
    function o(t, e, r) {
        var n = typeof r, s = 0, a = 0, u = 0, f = 0, h = 0, c = 0;
        if ("string" === n) {
            if ((h = i(r)) < 32) t.push(160 | h), c = 1; else if (h < 256) t.push(217, h), c = 2; else if (h < 65536) t.push(218, h >> 8, h), c = 3; else {
                if (!(h < 4294967296)) throw new Error("String too long");
                t.push(219, h >> 24, h >> 16, h >> 8, h), c = 5
            }
            return e.push({str: r, length: h, offset: t.length}), c + h
        }
        ...
        if ("object" === n) {
            ...
            if (Array.isArray(r)) {
                if ((h = r.length) < 16) t.push(144 | h), c = 1; else if (h < 65536) t.push(220, h >> 8, h), c = 3; else {
            ...
            if (r instanceof ArrayBuffer) {
                if ((h = r.byteLength) < 256) t.push(196, h), c = 2; else if (h < 65536) t.push(197, h >> 8, h), c = 3; else {
                    if (!(h < 4294967296)) throw new Error("Buffer too large");
                    t.push(198, h >> 24, h >> 16, h >> 8, h), c = 5
                }
                return e.push({bin: r, length: h, offset: t.length}), c + h
            }
            if ("function" == typeof r.toJSON) return o(t, e, r.toJSON());
            var p = [], y = "", d = Object.keys(r);
            for (s = 0, a = d.length; s < a; s++) y = d[s], "function" != typeof r[y] && p.push(y);
            if ((h = p.length) < 16) t.push(128 | h), c = 1; else if (h < 65536) t.push(222, h >> 8, h), c = 3; else {
    ...
    function s(t) {
        var e = [], r = [], i = o(e, r, t), s = new ArrayBuffer(i), a = new DataView(s), u = 0, f = 0, h = -1;
        r.length > 0 && (h = r[0].offset);
        for (var c, l = 0, p = 0, y = 0, d = e.length; y < d; y++) if (a.setUint8(f + y, e[y]), y + 1 === h) {
            if (c = r[u], l = c.length, p = f + h, c.bin) for (var v = new Uint8Array(c.bin), g = 0; g < l; g++) a.setUint8(p + g, v[g]); else c.str ? n(a, p, c.str) : void 0 !== c.float && a.setFloat64(p, c.float);
    ...
    function n(t) {
        if (this.offset = 0, t instanceof ArrayBuffer) this.buffer = t, this.view = new DataView(this.buffer); else {
    ...
    function i(t, e, r) {
        for (var n = "", i = 0, o = e, s = e + r; o < s; o++) {
            ...
            } else n += String.fromCharCode((15 & a) << 12 | (63 & t.getUint8(++o)) << 6 | (63 & t.getUint8(++o)) << 0); else n += String.fromCharCode((31 & a) << 6 | 63 & t.getUint8(++o)); else n += String.fromCharCode(a)
        }
        return n
    }

    function o(t) {
        var e = new n(t), r = e.parse();
    ...
    n.prototype.array = function (t) {
        ...
        var t, e = this.view.getUint8(this.offset++), r = 0, n = 0, i = 0, o = 0;
    ...
    var i = function () {
    ...
    }(), o = r(16).createBackoff, s = function () {
        function t(e, r) {
            var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
            n(this, t), this.url = e, this.protocols = r, this.reconnectEnabled = !0, this.listeners = {}, this.backoff = o(i.backoff || "exponential", i), this.backoff.onReady = this.onBackoffReady.bind(this), (void 0 === i.connect || i.connect) && this.open()
        }
        ...
        return i(t, [{
            ...
            key: "onBackoffReady", value: function (t, e) {
                this.open(!0)
            }
        }, {
            key: "onCloseCallback", value: function (t) {
    ...
    Object.defineProperty(e, "__esModule", {value: !0}), e.createBackoff = n;
    var o = {
        exponential: function (t, e) {
            return Math.floor(Math.random() * Math.pow(2, t) * e)
        }, fibonacci: function (t, e) {
            var r = 1;
            if (t > r) for (var n = 1, r = 2, i = 2; i < t; i++) {
                var o = n + r;
                n = r, r = o
            }
    ...
    (function (t) {
        ...
        function f(t, e) {
            if (a(e), t = i(t, e < 0 ? 0 : 0 | y(e)), !o.TYPED_ARRAY_SUPPORT) for (var r = 0; r < e; ++r) t[r] = 0;
            return t
        }
        ...
        function p(t, e) {
            ...
            if (e) {
                ...
                if ("Buffer" === e.type && Z(e.data)) return c(t, e.data)
            }
        ...
        function m(t, e, r, n, i) {
            ...
            if (i) {
                var h = -1;
                for (f = r; f < a; f++) if (o(t, f) === o(e, -1 === h ? 0 : f - h)) {
        ...
        function D(t, e, r, n, i) {
            return i || N(t, e, r, 4, 3.4028234663852886e38, -3.4028234663852886e38), X.write(t, e, r, n, 23, 4), r + 4
        }

        function Y(t, e, r, n, i) {
            return i || N(t, e, r, 8, 1.7976931348623157e308, -1.7976931348623157e308), X.write(t, e, r, n, 52, 8), r + 8
        }
        ...
        e.Buffer = o, e.SlowBuffer = d, e.INSPECT_MAX_BYTES = 50, o.TYPED_ARRAY_SUPPORT = void 0 !== t.TYPED_ARRAY_SUPPORT ? t.TYPED_ARRAY_SUPPORT : function () {
            ...
            for (var s = i - n, a = r - e, u = Math.min(s, a), f = this.slice(n, i), h = t.slice(e, r), c = 0; c < u; ++c) if (f[c] !== h[c]) {
                s = f[c], a = h[c];
                break
            }
        ...
        o.prototype.slice = function (t, e) {
            ...
            return t = +t, e |= 0, r || B(this, t, e, 4, 4294967295, 0), o.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : x(this, t, e, !0), e + 4
        }, o.prototype.writeUInt32BE = function (t, e, r) {
            return t = +t, e |= 0, r || B(this, t, e, 4, 4294967295, 0), o.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : x(this, t, e, !1), e + 4
            ...
            return t = +t, e |= 0, r || B(this, t, e, 4, 2147483647, -2147483648), o.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : x(this, t, e, !0), e + 4
        }, o.prototype.writeInt32BE = function (t, e, r) {
            return t = +t, e |= 0, r || B(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), o.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : x(this, t, e, !1), e + 4
            ...
            if ("number" == typeof t) for (s = e; s < r; ++s) this[s] = t; else {
                var a = o.isBuffer(t) ? t : J(new o(t, n).toString()), u = a.length;
    ...
    e.read = function (t, e, r, n, i) {
        var o, s, a = 8 * i - n - 1, u = (1 << a) - 1, f = u >> 1, h = -7, c = r ? i - 1 : 0, l = r ? -1 : 1,
            p = t[e + c];
        ...
        var s, a, u, f = 8 * o - i - 1, h = (1 << f) - 1, c = h >> 1,
    ...
    var n = r(25), i = function () {
        ...
        return t.prototype.set = function (t) {
            ...
            return this.state = t, this.checkPatches(e, this.listeners, this.defaultListener), e
        }, t.prototype.registerPlaceholder = function (t, e) {
            this.matcherPlaceholders[t] = e
        }, t.prototype.listen = function (t, e, r) {
            var i, o = this;
            "function" == typeof t ? (i = [], e = t) : i = t.split("/"), e.length > 1 && console.warn(".listen() accepts only one parameter.");
            var s = {
                callback: e, rawRules: i, rules: i.map(function (t) {
                    return "string" == typeof t ? 0 === t.indexOf(":") ? o.matcherPlaceholders[t] || o.matcherPlaceholders[":*"] : new RegExp("^" + t + "$") : t
                })
            };
            return 0 === i.length ? this.defaultListener = s : this.listeners.push(s), r && this.checkPatches(n.compare({}, this.state), [s]), s
            ...
            this.reset()
        }, t.prototype.checkPatches = function (t, e, r) {
            for (var n = 0, i = e.length; n < i; n++) for (var o = e[n], s = t.length - 1; s >= 0; s--) {
                var a = o && this.getPathVariables(t[s], o);
                a && (o.callback({
                    path: a,
                    rawPath: t[s].path,
                    operation: t[s].operation,
                    value: t[s].value
                }), t[s].matched = !0)
            }
            if (r) for (var s = t.length - 1; s >= 0; s--) t[s].matched || r.callback(t[s])
    ...
    function s(t, e, r, n) {
        for (var a = o(e), u = o(t), f = !1, h = u.length - 1; h >= 0; h--) {
            ...
            if (!e.hasOwnProperty(c) || void 0 === e[c] && void 0 !== l && !1 === Array.isArray(e)) r.push({
                ...
                var p = e[c];
                "object" == typeof l && null != l && "object" == typeof p && null != p ? s(l, p, r, i(n, c)) : l !== p && r.push({
                    operation: "replace",
                    path: i(n, c),
                    value: p,
                    previousValue: l
        ...
        if (f || a.length != u.length) for (var h = a.length - 1; h >= 0; h--) {
            var c = a[h];
            if (!t.hasOwnProperty(c) && void 0 !== e[c]) {
                var p = e[c], y = i(n, c);
                "object" == typeof p && null != p && s({}, p, r, y), r.push({operation: "add", path: y, value: p})
            }
        }
    }
    ...
    function n() {
        return "undefined" != typeof cc && cc.sys && cc.sys.localStorage ? cc.sys.localStorage : window.localStorage
    }
    ...
    Object.defineProperty(e, "__esModule", {value: !0}), e.setItem = i, e.getItem = o
}, function (t, e, r) {
    "use strict";
